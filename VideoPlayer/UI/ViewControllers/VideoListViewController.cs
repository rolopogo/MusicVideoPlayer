    ...
    class VideoListViewController : ViewController
    {
        ...
        protected override void DidActivate(bool firstActivation, ActivationType type)
        {
            ...
            {   
                ...
                //_searchButton = CustomUIElements.CreateUIButton(rectTransform, "CreditsButton", new Vector2(60, -20), new Vector2(30, 8), () =>
                //{
                //    searchButtonPressed?.Invoke();
                //}, "Refine");

                //_downloadButton = CustomUIElements.CreateUIButton(rectTransform, "CreditsButton", new Vector2(60, -30), new Vector2(30, 8), () =>
                //{
                ...
                //_loadingIndicator = CustomUIElements.CreateLoadingSpinner(rectTransform);
        ...
        private void _songsTableView_DidSelectRowEvent(TableView sender, int row)
        {
            ...
            //DidSelectRowEvent?.Invoke(sender, row);
        ...
        //{
        //    LevelListTableCell _tableCell = tableView.SelectCellWithIdx(idx);
